  ...
  const experiences = [
    {
      ...
      responsibilities: [
        "Developed and maintained scalable RESTful APIs using Django and Django Rest Framework (DRF).",
        "Wrote and executed unit tests, conducted API testing with Postman to ensure functionality and security.",
        "Optimized database queries, improving API response times and backend performance; resolved backend issues.",
        "Collaborated on React.js frontend development, contributing to UI components and seamless API integration.",
      ],
    },
    {
