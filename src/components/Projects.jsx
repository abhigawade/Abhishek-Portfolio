  ...
  const projects = [
    {
      ...
      features: [
        "Developed a full-stack news aggregation platform featuring real-time data fetching and personalized news recommendations.",
        "Integrated Natural Language Processing (NLP) for article summarization and implemented multilingual support to enhance accessibility.",
        "Implemented user-centric features such as news saving, sharing, and translation functionalities.",
        "Utilized Celery for efficient background task processing and SendGrid for email notifications.",
        "Designed a responsive user interface with React.js and Tailwind CSS, ensuring seamless user experience across devices.",
        "Optimized backend performance and scalability, incorporating token and cookie-based authentication mechanisms for secure user sessions.",
      ],
    ...
    },
    {
      ...
      features: [
        "Developed secure RESTful APIs with JWT authentication, supporting post creation, retrieval, and interaction features like follow, like, and comment.",
        "Built a dynamic personalized feed system that displays posts from followed users using optimized Django ORM queries.",
        "Integrated Jet Django Admin Panel for an enhanced admin experience and managed backend operations.",
        "Documented and thoroughly tested APIs using Postman, and deployed the project on PythonAnywhere for live access.",
      ],
